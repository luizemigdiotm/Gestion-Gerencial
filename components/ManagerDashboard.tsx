...
export const ManagerDashboard: React.FC = () => {
    ...
    const handleSaveModal = () => {
        if (editingActivity) {
            updateActivity(editingActivity.id, {
                collaboratorId: String(formData.collaboratorId),
                time: formData.time,
                                ...
                                <div className="p-5 space-y-5">
                                    ...
                                    <div>
                                        ...
                                        <div className="w-full bg-gray-200 rounded-full h-2.5">
                                            <div
                                                className={`h-2.5 rounded-full transition-all duration-500 ${stat.percentage > 85 ? 'bg-green-500' :
    ...
    const ConfigView = () => {
        ...
        // Manager Form State
        const [managerForm, setManagerForm] = useState<{ id?: string, name: string, employeeNumber: string } | null>(null);

        // Collaborator Form State
        const [collabForm, setCollabForm] = useState<{ id?: string, name: string, roleTitle: string, shift: ShiftType, employeeNumber: string, managerId?: string } | null>(null);
